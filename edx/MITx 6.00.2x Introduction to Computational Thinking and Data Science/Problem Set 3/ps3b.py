...
#        newGraphList.append(graphList[i]/float(numTrials))
#        newResistantGraphList.append(resistantGraphList[i]/float(numTrials))
#        
#    print(newGraphList)
#    print(newResistantGraphList)
#                    
#    pylab.plot(newGraphList, label = "TotalViruses")
#    pylab.plot(newResistantGraphList, label = "ResistantViruses")
