    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        if calculateHandlen(newHand) > 0:
            print("Current Hand: ", end=""), displayHand(newHand)
            ...
            if word  == ".":         
                ...
                if isValidWord(word, hand, wordList):                 
                    ...
                    print(str(word),"earned", str(wordScore),"points. Total:",str(totalScore),"points",sep=" ")
                    print("")       
                else:
                    print("Invalid word, please try again.")
                    print("")
        else:
            print("Run out of letters. Total score:",str(totalScore), "points.", sep=" ")
            return
